...
Поля обычного объявления: от одной до десяти фотографий, произвольное название автомобиля, положительные мощность и максимальная скорость без искусственного верхнего лимита, описание и цена. Подсказки названий необязательны и не ограничивают ввод. Минимальная цена — 100 AF Coins; быстрые значения: 100, 150, 200, 300, 400 и 500.
